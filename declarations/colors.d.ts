...
declare namespace colors {
	...
	type UnpackedRGB = LuaMultiReturn<
		[red: DecimalColorRange, green: DecimalColorRange, blue: DecimalColorRange]
	>;
	/** Phantom Type that is not currently being used to my knowledge but logically may at some point be. */
	type UnpackedRGBA = LuaMultiReturn<
		[
			red: DecimalColorRange,
			green: DecimalColorRange,
			blue: DecimalColorRange,
			alpha: DecimalColorRange
		]
	>;
