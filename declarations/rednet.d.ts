declare namespace rednet{
    ...
    function send(nRecipient: computerID, message: rednetMessage, sProtocol?: string): boolean;

    function broadcast(message: rednetMessage, nTimeout?: number): void;

    function receive(sProtocolFilter?: string, nTimeout?: number): [computer: computerID, message: rednetMessage, protocol: string | null] | null;
